...
export const Card: React.FC<CardProps> = ({ title, children, className }) => {
  return (
    <div className={`bg-gray-850 backdrop-blur-xl border border-gray-700 shadow-card rounded-2xl p-6 transition-all duration-300 hover:border-gray-600 ${className || ''}`}>
      {title && (
