...
import { CommandLineIcon, ClipboardIcon, CheckIcon, TrashIcon } from '../Icons';

export const SystemPromptTesterSection: React.FC = () => {
  const [systemPrompt, setSystemPrompt] = useState<string>('');
  const [generationMode, setGenerationMode] = useState<'test' | 'example'>('test');
    ...
    <div className="space-y-10 animate-fade-in max-w-5xl mx-auto">
      <header className="pb-8 border-b border-gray-700/50">
        ...
        <p className="mt-4 text-lg text-gray-400 max-w-3xl leading-relaxed">
          ...
          Paste it here, and our AI will generate either <strong>comprehensive QA Test Cases</strong> or <strong>Ideal User Examples</strong> to verify and showcase its capabilities.
        </p>
      </header>
      ...
      <Card className="bg-gray-850">
        <div className="space-y-8">
          <div>
            <label htmlFor="systemPrompt" className="block text-sm font-medium text-blue-300 mb-2">
          ...
          <div>
             <label className="block text-sm font-medium text-blue-300 mb-3">Generation Mode:</label>
             <div className="flex rounded-xl shadow-sm bg-gray-900 p-1 border border-gray-700 inline-flex" role="group">
              <button
                type="button"
            ...
            >
              {isLoading ? (
                ...
                <>
                  ...
                  {generationMode === 'test' ? 'Generate Test Cases' : 'Generate Examples'}
                </>
              )}
            </button>
            <button
      ...
      {generatedResult && (
        <Card title={generationMode === 'test' ? "Recommended Test Inputs" : "Ideal User Examples"} className="bg-gray-850 animate-slide-up">
