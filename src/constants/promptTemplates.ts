    ...
    templates: [
      {
        ...
        variables: [
          ...
          },
          {
            ...
            description:
              'The specific group of people you are writing for (e.g., "Beginner gardeners," "Expert software developers").',
          },
          {
            name: '[Primary_Keyword]',
            description: 'The main SEO keyword to focus on.',
          },
          {
            name: '[Secondary_Keywords]',
            description: '2-3 related keywords to include naturally.',
          },
          {
            name: '[Tone_of_Voice]',
            description:
              'The desired style of writing (e.g., "Informative and professional," "Casual and humorous," "Empathetic and supportive").',
          },
          {
            name: '[Desired_Length]',
            description:
              'The target word count for the article (e.g., "approximately 1200 words").',
          },
        ],
...
Ensure the final output is well-written, factually accurate (where applicable), and perfectly aligned with the specified tone and audience.`,
      },
      {
        ...
        useCase:
          'To generate a multi-platform social media campaign plan for a product, event, or announcement.',
        description:
          'This template helps you create a cohesive social media strategy. It prompts the AI to act as a social media manager, generating tailored content for different platforms, complete with hashtags and post schedules, ensuring a consistent message that resonates with your audience.',
        variables: [
          {
            name: '[Product/Event/Announcement]',
            description: 'The subject of the campaign.',
          },
          {
            name: '[Target_Audience]',
            description:
              'The demographic and interests of your audience (e.g., "Tech-savvy millennials aged 25-35").',
          },
          {
            name: '[Campaign_Goal]',
            description:
              'The primary objective (e.g., "Drive traffic to our website," "Increase brand awareness," "Generate ticket sales").',
          },
          {
            name: '[Key_Message]',
            description: 'The single most important takeaway for the audience.',
          },
          {
            name: '[Campaign_Duration]',
            description:
              'The length of the campaign (e.g., "1 week," "1 month").',
          },
        ],
    ...
    templates: [
      {
        ...
        useCase:
          'To distill long meeting transcripts or notes into a concise summary with clear action items.',
        description:
          'This template is perfect for improving productivity. It instructs the AI to process a block of text, identify the key decisions made, and clearly list out the action items, assigning them to the correct individuals. This saves time and ensures accountability.',
        variables: [
          {
            name: '[Meeting_Topic]',
            description:
              'The subject of the meeting (e.g., "Q3 Marketing Strategy Review").',
          },
          {
            name: '[Attendees]',
            description: 'A list of people present in the meeting.',
          },
          {
            name: '[Transcript_or_Notes]',
            description: 'The full, unedited text from the meeting.',
          },
        ],
...
| | | |`,
      },
      {
        ...
        useCase:
          'To analyze customer feedback and categorize it by sentiment, identifying key themes.',
        description:
          'This powerful template helps you quickly gauge customer opinion. The AI analyzes reviews, support tickets, or survey responses, determines the sentiment (Positive, Negative, Neutral), and extracts the core reasons for that sentiment, providing actionable insights.',
        variables: [
          {
            name: '[Product/Service_Name]',
            description: 'The product or service the feedback is about.',
          },
          {
            name: '[Customer_Feedback_List]',
            description:
              'A list of customer comments, reviews, or feedback entries, separated by new lines.',
          },
        ],
    ...
    templates: [
      {
        ...
        useCase:
          'To generate a well-documented and robust function in a specified programming language.',
        description:
          "This template streamlines the process of writing code. It asks the AI to act as a senior software engineer, ensuring the generated code is not only functional but also includes clear comments, docstrings, and error handling. It's a great way to produce high-quality, reusable code snippets.",
        variables: [
          {
            name: '[Programming_Language]',
            description:
              'The language for the function (e.g., "Python," "JavaScript," "Java").',
          },
          {
            name: '[Function_Purpose]',
            description: 'A clear description of what the function should do.',
          },
          {
            name: '[Input_Parameters]',
            description:
              'The inputs the function will take, including their expected data types.',
          },
          {
            name: '[Return_Value]',
            description:
              'The output the function should return, including its data type.',
          },
          {
            name: '[Specific_Requirements]',
            description:
              'Any special constraints or libraries to use (e.g., "Must be recursive," "Use the Pandas library," "Handle edge case of an empty list").',
          },
        ],
...
4.  **A simple example** demonstrating how to use the function.`,
      },
      {
        ...
        useCase:
          'To understand, get an explanation for, or debug a piece of provided code.',
        description:
          'This template is an invaluable tool for both learning and problem-solving. It instructs the AI to analyze a code snippet, explain its functionality in plain English, and identify any potential bugs or areas for optimization. It can turn complex code into an understandable lesson.',
        variables: [
          {
            name: '[Programming_Language]',
          ...
          {
            name: '[Code_Snippet]',
            description: 'The block of code you want to be analyzed.',
          },
          {
            name: '[Specific_Question_or_Error]',
            description:
              'Your specific question (e.g., "What does this do?", "Why am I getting a NullPointerException?", "How can I make this faster?").',
          },
        ],
    ...
    templates: [
      {
        ...
        useCase:
          'To draft a clear, professional, and effective email for a specific purpose.',
        description:
          'This template helps you craft the perfect email for any situation. By defining the goal, recipient, and key points, you can generate a well-structured email with the appropriate tone, saving time and ensuring your message is communicated effectively.',
        variables: [
          {
            name: '[Goal_of_the_Email]',
            description:
              'The primary purpose of the email (e.g., "To request a project extension," "To follow up on a sales lead," "To formally apologize for a service outage").',
          },
          {
            name: '[Recipient_Info]',
            description:
              'Who the email is for and their role (e.g., "My direct manager," "A potential new client," "Our entire customer base").',
          },
          {
            name: '[Key_Points_to_Include]',
            description:
              'A bulleted list of the essential information or questions that must be in the email.',
          },
          {
            name: '[Tone_of_Voice]',
            description:
              'The desired tone (e.g., "Formal and respectful," "Friendly and collaborative," "Urgent and direct," "Empathetic and apologetic").',
          },
          {
            name: '[Call_to_Action]',
            description:
              'What you want the recipient to do after reading the email (e.g., "Please approve this request by EOD," "Let me know your availability for a call next week").',
          },
        ],
...
Please draft the email, including a concise and professional subject line. Ensure the email is well-structured, easy to read, and achieves the stated goal while maintaining the specified tone.`,
      },
      {
        ...
        useCase:
          'To conduct a SWOT (Strengths, Weaknesses, Opportunities, Threats) analysis for a business, product, or project.',
        description:
          'This template provides a structured framework for strategic planning. The AI acts as a business analyst, using the information you provide to generate a detailed SWOT analysis, helping you identify key internal and external factors critical to your success.',
        variables: [
          {
            name: '[Company/Product/Project_Name]',
            description: 'The subject of the analysis.',
          },
          {
            name: '[Brief_Description]',
            description:
              'A short paragraph describing the subject and its market/purpose.',
          },
          {
            name: '[Known_Strengths]',
            description:
              'Internal positive factors (e.g., "Strong brand recognition," "Experienced team," "Proprietary technology").',
          },
          {
            name: '[Known_Weaknesses]',
            description:
              'Internal negative factors (e.g., "High operational costs," "Lack of marketing budget," "Limited distribution channels").',
          },
          {
            name: '[Market_Context]',
            description:
              'Information about the industry, competitors, and market trends.',
          },
        ],
    ...
    templates: [
      {
        ...
        useCase:
          'To break down a complex topic into a simple, easy-to-understand explanation using analogies.',
        description:
          'This template is perfect for learning. It instructs the AI to act as a skilled teacher, explaining a difficult concept as if talking to a five-year-old (ELI5), then providing a slightly more detailed explanation for an adult beginner. This dual approach makes any subject accessible.',
        variables: [
          {
            name: '[Complex_Topic]',
            description:
              'The concept you want to be explained (e.g., "Quantum Computing," "Blockchain," "General Relativity," "Machine Learning").',
          },
          {
            name: '[Key_Aspect_to_Focus_On]',
            description:
              'A specific part of the topic to emphasize, if any (e.g., "Focus on quantum superposition").',
          },
        ],
...
Provide a more detailed explanation suitable for an intelligent adult who has no prior knowledge of this subject. Avoid jargon where possible, or explain it clearly if you must use it. Use a different, more detailed analogy if it helps. Structure the explanation with clear headings for key components of the topic.`,
      },
      {
        ...
        useCase:
          'To create a structured study guide on a specific subject from notes or a block of text.',
        description:
          'This template transforms raw text or messy notes into a powerful learning tool. The AI organizes the information into key concepts, important definitions, and thought-provoking questions, creating a tailored study guide to help with revision and deepen understanding.',
        variables: [
          {
            name: '[Subject/Topic]',
            description:
              'The main subject the study guide is for (e.g., "World War II," "Cellular Biology," "Introduction to Python").',
          },
          {
            name: '[Source_Text_or_Notes]',
            description:
              'The block of text from an article, lecture, or your personal notes to be converted into a study guide.',
          },
          {
            name: '[Number_of_Questions]',
            description:
              'The number of summary questions you want to be generated.',
          },
        ],
    ...
    templates: [
      {
        ...
        useCase:
          'To generate unique and compelling story ideas based on a set of creative constraints.',
        description:
          "This template helps break through writer's block by combining different creative elements. The AI acts as a muse, generating several distinct story synopses that weave together your specified genre, character archetype, setting, and a plot twist, providing a solid foundation for a new story.",
        variables: [
          {
            name: '[Genre]',
            description:
              'The genre of the story (e.g., "Science Fiction," "Fantasy," "Mystery," "Horror").',
          },
          {
            name: '[Character_Archetype]',
            description:
              'The type of protagonist (e.g., "A cynical detective," "A reluctant hero," "A brilliant but disgraced scientist").',
          },
          {
            name: '[Setting]',
            description:
              'The time and place of the story (e.g., "A cyberpunk city in 2099," "A magical library that contains every book never written").',
          },
          {
            name: '[Mandatory_Object_or_Theme]',
            description:
              'An object or theme that must be central to the plot (e.g., "A broken compass," "The theme of betrayal").',
          },
        ],
...
- **Synopsis:**`,
      },
      {
        ...
        useCase:
          'To create a deep and multi-dimensional character profile for a story.',
        description:
          "This template helps writers develop rich, believable characters. By providing a basic concept, the AI fleshes out the character's backstory, motivations, flaws, and quirks, creating a comprehensive profile that can be used as a reference throughout the writing process.",
        variables: [
          {
            name: '[Character_Name]',
          ...
          },
          {
            name: '[Basic_Concept]',
            description:
              'A one-sentence idea for the character (e.g., "A space pirate who secretly writes poetry," "An elderly librarian who discovers she has magic powers").',
          },
          {
            name: '[Role_in_Story]',
            description:
              'The character\'s role (e.g., "Protagonist," "Antagonist," "Mentor," "Sidekick").',
          },
        ],
