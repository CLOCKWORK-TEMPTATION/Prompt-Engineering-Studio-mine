...
import { SparklesIcon } from '@/components/ui/Icons'; // Main app icon
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              <span
                className={`relative z-10 transition-colors duration-200 ${isActive ? 'text-blue-400' : 'text-gray-500 group-hover:text-gray-300'}`}
              >
                {item.icon}
              </span>
