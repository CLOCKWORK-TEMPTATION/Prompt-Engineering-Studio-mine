    ...
    <div className="bg-gray-850 rounded-lg p-3 sm:p-4 shadow-md">
      ...
      <div className="relative">
        ...
        {showLeftArrow && (
          <button
            onClick={() => scroll('left')}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1/2 w-8 h-8 rounded-full bg-gray-900/80 hover:bg-gray-800 backdrop-blur-sm border border-gray-600 text-gray-300 flex items-center justify-center transition-opacity"
        ...
        {showRightArrow && (
          <button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 w-8 h-8 rounded-full bg-gray-900/80 hover:bg-gray-800 backdrop-blur-sm border border-gray-600 text-gray-300 flex items-center justify-center transition-opacity"
